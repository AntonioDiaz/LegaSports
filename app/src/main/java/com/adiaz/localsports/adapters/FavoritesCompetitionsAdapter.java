...
public class FavoritesCompetitionsAdapter extends RecyclerView.Adapter<FavoritesCompetitionsAdapter.ViewHolder> {
	...
	public void onBindViewHolder(ViewHolder holder, int position) {
		...
		holder.tvSubTitle01.setText(LocalSportsUtils.getStringResourceByName(context, competitionsFavorites.get(position).sportName()));
		holder.tvSubTitle02.setText(LocalSportsUtils.getStringResourceByName(context,competitionsFavorites.get(position).categoryName()));
