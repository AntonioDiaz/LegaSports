...
public class CalendarAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup viewGroup) {
		...
		if (teamLocal.equals(LocalSportsConstants.UNDEFINDED_FIELD) && teamVisitor.equals(LocalSportsConstants.UNDEFINDED_FIELD)) {
		...
		String strResult = "";
		switch (match.state()) {
			case LocalSportsConstants.STATE_PENDING:
				strResult = mContext.getString(R.string.match_pending);
				break;
			case LocalSportsConstants.STATE_CANCELED:
				strResult = mContext.getString(R.string.match_cancel);
				break;
			case LocalSportsConstants.STATE_PLAYED:
