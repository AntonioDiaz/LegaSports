...
public class NotificationUtils {
	...
	public static void remindUserBecauseCharging(Context context, Competition competition) {
		...
		NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
				...
				.setContentIntent(contentIntent(context, competition))
				.setAutoCancel(true);
		...
		//disable notification for this competition.
		ContentResolver contentResolver = context.getContentResolver();
		ContentValues contentValues = new ContentValues();
		contentValues.put(CompetitionsEntry.COLUMN_LAST_NOTIFICATION, competition.getLastUpdateServer());
		String selection = CompetitionsEntry.COLUMN_ID_SERVER + "=?";
		String[] selectionArgs = new String[]{competition.getServerId()};
