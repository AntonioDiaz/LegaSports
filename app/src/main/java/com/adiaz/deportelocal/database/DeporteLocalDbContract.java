...
public class DeporteLocalDbContract {

    public static final String AUTHORITY = "com.adiaz.deportelocal";
    ...
    public static final class MatchesEntry implements BaseColumns {
        ...
        public static final String COLUMN_WEEK_NAME = "week_name";
        ...
        public static final int INDEX_WEEK_NAME = 6;
        public static final int INDEX_ID_SPORTCENTER = 7;
        public static final int INDEX_DATE = 8;
        public static final int INDEX_ID_SERVER = 9;
        public static final int INDEX_ID_COMPETITION_SERVER = 10;
        public static final int INDEX_STATE = 11;
        ...
        public static Match initEntity(Cursor cursorMatches) {
            ...
            Match match = Match.builder()
                    ...
                    .setWeekName(cursorMatches.getString(MatchesEntry.INDEX_WEEK_NAME))
