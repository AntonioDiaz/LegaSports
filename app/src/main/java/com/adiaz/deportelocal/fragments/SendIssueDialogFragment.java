...
public class SendIssueDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strSport = DeporteLocalUtils.getStringResourceByName(this.getActivity(), mCompetition.sportName());
        ...
        if (alertDialog != null) {
            ...
            positiveButton.setOnClickListener(new View.OnClickListener() {
                ...
                if (!TextUtils.isEmpty(edDescription.getText())) {
                    ...
                    if(user!=null) {
                        onSendIssue.doSendIssue(mCompetition, mMatch, edDescription.getText().toString(), user.getEmail());
                    }
                    dismiss();
                } else {
