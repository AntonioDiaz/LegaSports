...
import com.adiaz.deportelocal.utilities.DateTypeAdapter;
...
public abstract class Match implements Parcelable {
    ...
    public abstract static class Builder {
        ...
        public abstract Builder setWeekName(String value);
    ...
    public boolean isCourtDefinded(Context context) {
        Court court = DeporteLocalCourts.obteinTownCourt(context, this.idSportCenter());
        return court != null;
    }
